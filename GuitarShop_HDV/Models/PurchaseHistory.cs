...
namespace GuitarShop_HDV.Models
{
    public class PurchaseHistory
    {
        ...
        public PurchaseHistory(int id, int transactionID, int idGuitar, int quantity, double amount, DateTime created, string guitarName, DateTime? updated, bool status, bool isCanceled, bool userCanceled)
        {
            this.id = id;
